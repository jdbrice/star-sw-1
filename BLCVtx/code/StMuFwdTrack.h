...
public:
    ...
    void setTrackType( UChar_t trackType ) { mTrackType = trackType; } // BBB
    ...
    UChar_t trackType() const { return mTrackType; } // BBB
...
protected:
    ...
    UChar_t mVtxIndex;
    UChar_t mTrackType = 0; // BBB: StFwdTrack::StFwdTrackType value (0=Global,1=BLC,2=Primary,3=FwdVtx,4=BLCVtx)

    ClassDef(StMuFwdTrack,4) // BBB: version 4 adds mTrackType
